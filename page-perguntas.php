      ...
      <div class="accordion" id="accordionExample">
        <div class="accordion-item">
          <h2 class="accordion-header" id="heading<?php echo $informacoes['acordion']; ?>">
            <button class="accordion-button collapsed v-expansion-panel-header" type="button" data-bs-toggle="collapse"
              data-bs-target="#collapse<?php echo $informacoes['acordion']; ?>" aria-expanded="true"
              aria-controls="collapse<?php echo $informacoes['acordion']; ?>">
              <?php echo $informacoes['subtitulo_do_acordion'] ?>
            </button>
          </h2>
          <div id="collapse<?php echo $informacoes['acordion']; ?>" class="accordion-collapse collapse"
            aria-labelledby="heading<?php echo $informacoes['acordion']; ?>" data-bs-parent="#accordionExample">
