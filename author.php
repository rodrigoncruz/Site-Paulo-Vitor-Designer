...
<main class="blog">
    <div class="nav-banner-blog">
        <img class="img-banner position-relative"
            src=<?php echo get_template_directory_uri() . '/assets/img/banner-archive.png' ?> alt="Banner Blog">
                ...
                <div class="pt-5 pb-5 col-lg-4">
                    <div class="">
                        <a href=<?php the_permalink(); ?>><img class="img-posts" src=<?php the_post_thumbnail();?></a>
                                </div> <div class="bg-white card-text">
                            <div class="about-par-posts">
                                <h2 class="title"><?php the_title(); ?></h2>
                                <p><?php the_excerpt(20); ?></p>
                                <div class="d-flex align-items-center comments mb-2">
                                    <img src=<?php echo get_template_directory_uri() . '/assets/img/comentarios.png' ?>
                                        alt="">
                                    <?php
